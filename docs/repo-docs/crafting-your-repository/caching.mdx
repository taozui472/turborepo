...
![12 tasks are being run in 3 packages, resulting in a ">>> FULL TURBO" cache hit. The total time it takes to restore these tasks from cache is 80 milliseconds.](/images/docs/why-turborepo-solution.png)  
...
![A terminal window showing two tasks that have been run through `turbo`. They successfully complete in 116 milliseconds.](/images/docs/full-turbo.png)
